...
function Portada() {
    return (
        <div className="portada">
            <video className='videoH' src="./img/beliePortadaH.mp4" autoPlay muted loop></video>
            <video className='videoV' src="./img/beliePortadaV.mp4" autoPlay muted loop></video>
            <div className="portada_textos">
                <h1>Belié tiene una <span className='portada_highlight'> gran sorpresa</span> para vos.</h1>
                <p>Falta muy poco para que contemos todas las novedades! Mientras tanto 
